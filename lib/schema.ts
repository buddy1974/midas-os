...
export const lots = pgTable("lots", {
  ...
  tenure: varchar("tenure", { length: 30 }),
  ...
  legalPackUrl: varchar("legal_pack_url", { length: 500 }),
  ...
  addressVisible: boolean("address_visible").default(true).notNull(),
...
export const events = pgTable("events", {
  ...
  currentRegistrations: integer("current_registrations").default(0).notNull(),
  pricePence: integer("price_pence").default(0),
  costType: varchar("cost_type", { length: 20 }).default("free"),
  costAmount: integer("cost_amount").default(0),
  ticketLink: varchar("ticket_link", { length: 500 }),
  externalTicketUrl: varchar("external_ticket_url", { length: 500 }),
  eventbriteUrl: varchar("eventbrite_url", { length: 500 }),
  lotId: uuid("lot_id"),
  coverImage: varchar("cover_image", { length: 500 }),
  thumbnailUrl: varchar("thumbnail_url", { length: 500 }),
  images: text("images").default("[]"),
  videoUrl: varchar("video_url", { length: 500 }),
  recapVideoUrl: varchar("recap_video_url", { length: 500 }),
  registrationType: varchar("registration_type", { length: 20 }).default("form").notNull(),
  formFields: varchar("form_fields", { length: 20 }).default("full").notNull(),
  showInvestorOption: boolean("show_investor_option").default(false).notNull(),
  customButtonLabel: varchar("custom_button_label", { length: 100 }),
  customButtonUrl: varchar("custom_button_url", { length: 500 }),
  customButtons: text("custom_buttons").default("[]"),
  recapUrl: varchar("recap_url", { length: 500 }),
...
export const contentHistory = pgTable("content_history", {
  ...
  label: varchar("label", { length: 200 }),
  changedAt: timestamp("changed_at").default(sql`now()`).notNull(),
});
